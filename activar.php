        ...
        <div class="container">
            <div class="row">
                <div class="col-md- col-lg- col-xl- col-md- col-lg- col-xl- mx-auto">
                    <!-- Default form login -->
                    <div class="card" style="margin-top:29%; margin-bottom:29%;">
                        ...
                        <form class="text-center border border-light p-4" method="POST" action="<?php $_SERVER['PHP_SELF'] ?>">
                            
                            <p class="h4 mb-5">Ingresar</p>

                            <!-- Email -->
                            <input type="email" id="defaultLoginFormEmail" name="email" class="form-control mb-4" placeholder="E-mail">

                            <!-- Password -->
                            <input type="password" id="defaultLoginFormPassword" name="password" class="form-control mb-2" placeholder="Password">
