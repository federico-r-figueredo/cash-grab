        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <div class="card" style="margin-top:10%; margin-bottom:10%;">
                    <form class="text-center border border-light p-5" action="datos.php">

                        <h2 class="h2 mb-4">Términos y Condiciones</h2>

                        <p class="text-center">
                        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur et turpis tincidunt, vulputate velit id, rutrum nibh. Nullam pharetra vulputate eleifend. Duis ornare mi eget tristique porttitor. Morbi id nulla sit amet orci pretium mattis. Aenean vitae massa nec ante accumsan aliquam ut in augue. Integer placerat pharetra sem, nec pellentesque eros consequat in. Mauris interdum urna nec quam convallis, sit amet facilisis lacus feugiat. Fusce bibendum eros sit amet ipsum pharetra, ac imperdiet arcu viverra. Mauris tristique lorem nibh, a ullamcorper orci porttitor et. Vestibulum a pellentesque leo, sed sodales nunc. Nulla facilisi. Maecenas sit amet fringilla dui. 
                        </p>
