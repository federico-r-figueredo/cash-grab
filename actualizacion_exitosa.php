        ...
        <div class="row">
            <div class="col-md-8 mx-auto">
                ...
                <div class="card" style="margin-top:27%; margin-bottom:27%;">
                    <form class="text-center border border-light p-5" action="panel_usuarios.php">

                        <div class="alert alert-success" role="alert" >
                            ¡Los datos de su cuenta han sido actualizados con exito!
                        </div>
                        
    

                            <button class="btn btn-info my-4 purple-gradient" type="submit">Panel de usuario</button>
